    ...
    <div class="container">
        <div class="row">
                <div class="col-md-8 col-12 offset-md-2 ">
                    ...
                    <form action="<?php echo e(route('add.product.complete')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel\day-1\Task-2\fashion\resources\views/backend/addProduct.blade.php ENDPATH**/ ?>